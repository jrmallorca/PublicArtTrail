...
public class MapsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setting up show/disable current location
    ...
    // Sets the visibility of the currentLocationButton
    ...
    // If we have permission, get location and set up map
    private void GetLastLocation() {
        // If permission for location is missing, request it
        ...
        // On success, get location and set map
