package com.publicarttrail.googlemapspractice.recyclerView;
...
public class TestUtils {
    ...
    public static CustomRecyclerViewMatchers withRecyclerView(final int recyclerViewId) {

        return new CustomRecyclerViewMatchers(recyclerViewId);
    }
